...
<main class="main">
    <!--==================== HOME ====================-->
    <section class="home" style="background-color: #4e5aff">
        <div class="home__container container">
            <div class="home__data">
                <span class="home__subtitle">Error 403</span>
                <h1 class="home__title">Для продолжения авторизуйтесь</h1>
                <p class="home__description">
                    Для входа на страницу вы должны авторизоваться <br> или обладать правами доступа.
                </p>

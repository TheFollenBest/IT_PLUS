                                        ...
                                        <div class="split-view split-view_direction_column trainer__left-column">
                                            <div class="split-view__pane" style="flex-grow: 1.5">
                                                ...
                                                <div id="HTML" class="tabcontent">
                                                    <textarea id="editor-html" name="editor_html" class="editor-html">{!! $lesson[0]->code !!}</textarea>
                                                </div>
                                                <div id="CSS" class="tabcontent">
                                                    <textarea id="editor-css" name="editor_css" class="editor-css"></textarea>
                                                </div>
                                                <div id="JS" class="tabcontent">
                                                    <textarea id="editor-js" name="editor_js" class="editor-js"></textarea>
                                                </div>
                                            </div>
                                            <div class="split-view__pane" style="flex-grow: 1.5;">

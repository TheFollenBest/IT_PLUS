...
<body>
    ...
    <section class="education container">
        ...
        <div class="education-wrp-bottom">
            ...
            <p class="education__text"><span class="education__text--bold">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur, earum rerum? Rem provident facilis unde atque harum vitae recusandae, corrupti ratione pariatur corporis reprehenderit sit alias dolorem, odit eum exercitationem!</p>
        </div>
    </section>
    <!-- EDUCATION END -->
